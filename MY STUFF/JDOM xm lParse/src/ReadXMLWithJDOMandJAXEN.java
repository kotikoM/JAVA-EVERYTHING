...
//        org.jdom2.xpath.XPathExpression<Element> expression = xPathFactory.compile(filter, Filters.element());
//        List<Element> custElements = expression.evaluate(doc);
    ...
    public static void main(String[] args) throws ParseException, DataConversionException, XPathExpressionException {
        ReadXMLWithJDOMandJAXEN reader = new ReadXMLWithJDOMandJAXEN();
